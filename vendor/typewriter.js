(function (global) {
  ...
  if (!global.jQuery) throw new Error('TypeWriter.js requires jQuery to work');
  ...
  function setupTypeWriter(TypeWriter) {
    ...
    TypeWriter.container.append(
      '<span class="tw-span" style="visibility: visible; width: 100%">' +
        '<span class="tw-content"></span>' +
        (TypeWriter.caretOn
          ? '<span class="tw-caret" id="tw-caret" style="visibility: visible;">|</span>'
  ...
  global.jQuery.prototype.type = function (callback, speed, offset, caretOn) {
    ...
    this.hiddenTypeWriter =
      this.hiddenTypeWriter || new TypeWriter(this.selector, speed, caretOn);
