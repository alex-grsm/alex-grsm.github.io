...
$(function() {
  ...
  $(".main-head .toggle-mnu").click(function() {
    $(this).toggleClass("on");
    $(".main-head #mob-mnu").slideToggle('fast');
    return false;
  });


  //Scroll to ID
  $(".main-mnu a[href*='#'], #mob-mnu a[href*='#']").mPageScroll2id();
  ...
  // FAQ tabs
  $('.ej-9__item-head').click(function(){
    //creation d'une variable pour cibler les éléments qui apparaissent au clic
    var drop = $(this).next();
    drop.slideDown('100');
    $('.ej-9__item-head').next().not(drop).slideUp("100");
    $(this).children('.icon_arrow').html('<i class="fa fa-angle-down"></i>');
    $(this).addClass('active');
    $('.ej-9__item-head').not(this).children('.icon_arrow').html('<i class="fa fa-angle-right"></i>');
    $('.ej-9__item-head').not(this).removeClass('active');
  });
  // Le premier volet est ouvert par défaut
  $('.ej-9__item-head').first().trigger('click');
