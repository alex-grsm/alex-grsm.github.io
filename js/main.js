...
document.addEventListener('DOMContentLoaded', () => {
  ...
  *******************************************/
  ...
  new PortfolioCase('img/preview/case-petroleum-products.webp', 'Supplier of petroleum products', 'Landing', 'Developed - Alex Herasymchuk', 'Working in freelancing', 'https://sv-transservice.com.ua/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-parallax-gallery.webp', 'Parallax Gallery', 'Template', 'Developed - Alex Herasymchuk', '', 'https://alex-grsm.github.io/showcase/parallax-gallery', 'https://github.com/alex-grsm/parallax-gallery', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-3d-slider.webp', '3D Slider', 'Template', 'Developed - Alex Herasymchuk', '', 'https://alex-grsm.github.io/showcase/3d-slider', 'https://github.com/alex-grsm/3d-slider', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/fairy-slider.webp', 'Fairy Slider', '', 'Developed - Alex Herasymchuk', '', 'https://alex-grsm.github.io/showcase/fairy-slider/', 'https://github.com/alex-grsm/fairy-slider', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/cametet.webp', 'Cametet', '', 'Developed - Alex Herasymchuk', 'Working in freelancing', 'https://cametet.com/', 'https://github.com/alex-grsm/p-cametet', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'business').render();
  new PortfolioCase('img/preview/case-slider.webp', 'Case slider', '', 'Developed - Alex Herasymchuk', '', 'https://alex-grsm.github.io/showcase/case-slider/', 'https://github.com/alex-grsm/swiper-cases-anim-slider', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/fairy-forest.webp', 'Fairy Forest', '', 'Developed - Alex Herasymchuk', '', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/fairy-forest', 'https://github.com/alex-grsm/fairy-forest', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
