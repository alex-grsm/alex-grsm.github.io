...
/* harmony import */ var _vendor_particles_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/particles.min.js */ "./src/js/vendor/particles.min.js");
/* harmony import */ var _vendor_particles_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_particles_min_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _vendor_jquery_waypoints_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/jquery.waypoints.min.js */ "./src/js/vendor/jquery.waypoints.min.js");
...
/* harmony import */ var _vendor_imagesloaded_pkgd_min_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/imagesloaded.pkgd.min.js */ "./src/js/vendor/imagesloaded.pkgd.min.js");
/* harmony import */ var _vendor_imagesloaded_pkgd_min_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_vendor_imagesloaded_pkgd_min_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _vendor_jquery_filterizr_min_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor/jquery.filterizr.min.js */ "./src/js/vendor/jquery.filterizr.min.js");
/* harmony import */ var _vendor_jquery_filterizr_min_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_vendor_jquery_filterizr_min_js__WEBPACK_IMPORTED_MODULE_4__);
// import $ from 'jquery';
// window.jQuery = $;
// window.$ = $;
...
// import '../../node_modules/filterizr/dist/vanilla.filterizr.min.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  *******************************************/
  ...
  $('.nav-toggle-btn').on('click', toggleBtnHandler);
  ...
  *******************************************/
  //particles
  particlesJS.load('main-header', '../vendor/particleconfignasa.json');
  ...
  *******************************************/
  ...
  class PortfolioCase {
    constructor(imgSrc, title, p1, p2, p3, btnLife, btnDev, parentSelector) {
      this.imgSrc = imgSrc;
      this.title = title;
      this.p1 = p1;
      this.p2 = p2;
      ...
      this.btnDev = btnDev;
      for (var _len = arguments.length, classes = new Array(_len > 8 ? _len - 8 : 0), _key = 8; _key < _len; _key++) {
        classes[_key - 8] = arguments[_key];
      }
    ...
    render() {
      ...
      this.classes.forEach(className => {
        caseItem.classList.add(className);
      });
      caseItem.innerHTML = `
      <img class="img-responsive showcase-img" src="${this.imgSrc}" alt="${this.title}">
      <div class="item-desc">
        <h4>${this.title}</h4>
        <p>${this.p1}</p>
        <p>${this.p2}</p>
        <p>${this.p3}</p>
        <div class="buttons">
          <a class="button" href="${this.btnLife}" target="_blank" rel="noreferrer">Visit</a>
          <a class="button gitHubLink" href="${this.btnDev}" target="_blank" rel="noreferrer">GitHub</a>
        </div>
      </div>
    `;
      this.parent.prepend(caseItem);
    }
  }
  new PortfolioCase('img/preview/case-bussines.webp', 'Business formula', 'Marketing', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://alex-grsm.github.io/showcase/lmarketing/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/lmarketing', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-krasota.webp', 'S&Mitler', 'Beauty salon', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://alex-grsm.github.io/showcase/krasota/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/krasota', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-afg.webp', 'Armata Financical Group', 'Website with scroll animation', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://alex-grsm.github.io/showcase/afg/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/afg', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-medvedka.webp', 'Medvedka', 'Medicine', 'Developed Front End - Alex Herasymchuk', 'Working in the company — Asabix', 'https://alex-grsm.github.io/showcase/medvedka/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/medvedka', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-tower.webp', 'Tower', 'Restaurant', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://alex-grsm.github.io/showcase/tower/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/tower', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-losen.webp', 'Losen', 'Сosmetology', 'Developed Front End - Alex Herasymchuk', 'Working in the company — Asabix', 'https://alex-grsm.github.io/showcase/losen/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/losen', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-beautyshape.webp', 'Beauty Shape', 'Beauty clinic', 'Developed Front End - Alex Herasymchuk', 'Working in the company — Asabix', 'https://alex-grsm.github.io/showcase/beautyshape/map.html', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/beautyshape', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'business').render();
  new PortfolioCase('img/preview/case-ucard.webp', 'Your Card', 'Some Animation Card', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://alex-grsm.github.io/showcase/ucard/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/ucard', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-lenses.webp', 'AMAZING LENSES', 'Eye lens shop', 'Developed Front & Back Ends — Alex Herasymchuk', 'Working in freelancing', 'https://lenses.bestprofit.top/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-fly.webp', 'Dinamica', 'Online shop', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://alex-grsm.github.io/showcase/dinamica/map.html', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/dinamica', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'ecommerce').render();
  new PortfolioCase('img/preview/case-steffany.webp', 'Steffany', 'Franchise', 'Developed Front & Back Ends — Alex Herasymchuk', 'Working in freelancing', 'https://alex-grsm.github.io/showcase/steffany/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/steffany', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-armer.webp', 'Armer', 'Сar accessories catalog', 'Developed Front — Alex Herasymchuk', 'Working in freelancing', 'https://armer.com.ua/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'ecommerce').render();
  new PortfolioCase('img/preview/case-axxis.webp', 'AXXIS', 'Сatalog of accessories and tools', 'Developed Front — Alex Herasymchuk', 'Working in freelancing', 'https://www.axxis-chemicals.com/en/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'ecommerce').render();
  new PortfolioCase('img/preview/case-roof.webp', 'Roof', 'Roofing materials and work', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://alex-grsm.github.io/showcase/roof/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/roof', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-kyivstar.webp', 'Kyivstar', 'Internet provider', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://my-kyivstar.com.ua/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-xpand.webp', 'Xpand', 'Case for xpand company', 'Developed Front End - Alex Herasymchuk', 'Working in the agency — Doris Advertising', 'http://digital.doris.agency/xpand', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-great.webp', 'GR8', 'Translation Agency', 'Developed Front End - Alex Herasymchuk', 'Working in the agency — Doris Advertising', 'https://gr8.com.ua/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'business').render();
  new PortfolioCase('img/preview/case-gelato.webp', 'GELATO', 'Promo site — ice cream', 'Developed Front End - Alex Herasymchuk', 'Working in the agency — Doris Advertising', 'https://gelato.rud.ua/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-doris.webp', 'Doris Advertising', 'Website for Doris digital agency', 'Developed Front End - Alex Herasymchuk', 'Working in the agency — Doris Advertising', 'http://digital.doris.agency/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-husky.webp', 'Husky', 'Case for Husky company', 'Developed Front End - Alex Herasymchuk', 'Working in the agency — Doris Advertising', 'http://digital.doris.agency/husky', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-green.webp', 'Green', 'Design and landscaping', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://alex-grsm.github.io/showcase/green/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/green', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'business').render();
  new PortfolioCase('img/preview/case-leri.webp', 'Leri', 'Online shop', 'Developed Front End - Alex Herasymchuk', 'Working in the company — Asabix', 'https://alex-grsm.github.io/showcase/leri/map.html', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/leri', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'ecommerce').render();
  new PortfolioCase('img/preview/case-bioform.webp', 'Bioform', 'Medicine', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://alex-grsm.github.io/showcase/bioform/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/bioform', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'business').render();
  new PortfolioCase('img/preview/case-alfa.webp', 'Ainvest', 'Investment', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://alfa-invest.club/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-atlantic.webp', 'Atlantic', 'Online catalog', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://www.atlanticgeyser.com.ua/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'ecommerce').render();
  new PortfolioCase('img/preview/case-prosto.webp', 'Prosto CNC', 'Online store - CNC machines', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://www.prostocnc.com/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'ecommerce').render();
  new PortfolioCase('img/preview/case-alpha.webp', 'ALPHA', 'Quality rentals', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://alex-grsm.github.io/showcase/alpha/', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/alpha', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();
  new PortfolioCase('img/preview/case-omega.webp', 'Omega', 'Distributor of auto components', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://omega.page/en', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'business').render();
  new PortfolioCase('img/preview/case-beatnik.webp', 'BEATNIKSPACE', 'Store of original shoes, clothes and accessories', 'Developed Front & Back Ends — Alex Herasymchuk', 'Working in freelancing', 'https://beatnik.space/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'ecommerce').render();
  new PortfolioCase('img/preview/case-marcipan.webp', 'Pan marzipan', 'Restaurant', 'Developed Front End - Alex Herasymchuk', 'Working in the agency — Doris Advertising', 'http://marcipanzt.com.ua/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'business').render();
  new PortfolioCase('img/preview/case-gourman.webp', 'Gourman', 'Online shop', 'Developed Front End - Alex Herasymchuk', 'Working in the company — Asabix', 'https://alex-grsm.github.io/showcase/gourman/map.html', 'https://github.com/alex-grsm/alex-grsm.github.io/tree/master/showcase/gourman', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item', 'ecommerce').render();
  new PortfolioCase('img/preview/case-carreblanccannes.webp', 'LE CARRE BLANC', 'Striptease club', 'Developed Front End - Alex Herasymchuk', 'Working in freelancing', 'https://carreblanccannes.com/en/', '', '#showcase-container', 'col-md-4', 'filtr-item', 'showcase-item').render();

  /** FIx filters */
  const itemCase = document.querySelectorAll('.showcase-item');
  itemCase.forEach(function (item) {
    if (item.classList.contains('business')) {
      item.setAttribute('data-category', '2');
    } else if (item.classList.contains('ecommerce')) {
      item.setAttribute('data-category', '3');
    } else {
      item.setAttribute('data-category', '1');
    }
  });

  /** Fix gitHubLink */
  const itemCaseGitHubLink = document.querySelectorAll('.gitHubLink');
  itemCaseGitHubLink.forEach(link => {
  ...
  if (mediaQueryXL.matches) {
    $('.showcase-item').addClass('col-lg-3');
  }

  /** Back to top btn */
  const toggleHeight = $(window).outerHeight() * 3;
